...
CreateCommand.prototype.list = function() {
  ...
  fs.readdir(dirUtils.getCacheDir(), function (err, files) {

    // if there are no errors and the directory is not empty
    // attempt to list cache contents.
...
CreateCommand.prototype.clean = function() {
  var self = this;
  var rmPath = dirUtils.getCacheDir();
